...
public class TaskList implements ICallBack{
	...
	private final List<Task> runningTasks = new ArrayList<Task>();
	private final List<Task> queuedTasks = new ArrayList<Task>();
...
//	private static final ErrorMessageList errorMessageList = ErrorMessageManager.getErrorMessageList();
	...
	private int completedTaskExpiration = 2;
	...
	private void cleanupCompletedTasks()
	{
		...
		for(int i=listSize-1;i>=0;i--)
		{
			...
			c.add(Calendar.HOUR, completedTaskExpiration);
			//logger.debug(c);
